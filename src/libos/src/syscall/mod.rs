...
macro_rules! process_syscall_table_with_callback {
    ($callback: ident) => {
        $callback! {
            ...
            (Mincore = 27) => handle_unsupported(27),
            ...
            (Pause = 34) => handle_unsupported(34),
            (Nanosleep = 35) => do_nanosleep(req_u: *const timespec_t, rem_u: *mut timespec_t),
            (Getitimer = 36) => handle_unsupported(36),
            (Alarm = 37) => handle_unsupported(37),
            (Setitimer = 38) => handle_unsupported(38),
            (Getpid = 39) => do_getpid(),
            ...
            (Semget = 64) => handle_unsupported(64),
            (Semop = 65) => handle_unsupported(65),
            (Semctl = 66) => handle_unsupported(66),
            (Shmdt = 67) => do_shmdt(shmaddr: usize),
            (Msgget = 68) => handle_unsupported(68),
            (Msgsnd = 69) => handle_unsupported(69),
            (Msgrcv = 70) => handle_unsupported(70),
            (Msgctl = 71) => handle_unsupported(71),
            ...
            (Times = 100) => handle_unsupported(100),
            (Ptrace = 101) => handle_unsupported(101),
            (Getuid = 102) => do_getuid(),
            (SysLog = 103) => handle_unsupported(103),
            (Getgid = 104) => do_getgid(),
            (Setuid = 105) => handle_unsupported(105),
            (Setgid = 106) => handle_unsupported(106),
            ...
            (Setsid = 112) => handle_unsupported(112),
            (Setreuid = 113) => handle_unsupported(113),
            (Setregid = 114) => handle_unsupported(114),
            (Getgroups = 115) => do_getgroups(size: isize, buf_ptr: *mut u32),
            (Setgroups = 116) => handle_unsupported(116),
            (Setresuid = 117) => handle_unsupported(117),
            (Getresuid = 118) => handle_unsupported(118),
            (Setresgid = 119) => handle_unsupported(119),
            (Getresgid = 120) => handle_unsupported(120),
            (Getpgid = 121) => do_getpgid(pid: i32),
            (Setfsuid = 122) => handle_unsupported(122),
            (Setfsgid = 123) => handle_unsupported(123),
            (Getsid = 124) => handle_unsupported(124),
            (Capget = 125) => handle_unsupported(125),
            (Capset = 126) => handle_unsupported(126),
            ...
            (RtSigqueueinfo = 129) => handle_unsupported(129),
            ...
            (Mknod = 133) => handle_unsupported(133),
            (Uselib = 134) => handle_unsupported(134),
            (Personality = 135) => handle_unsupported(135),
            (Ustat = 136) => handle_unsupported(136),
            (Statfs = 137) => do_statfs(path: *const i8, statfs_buf: *mut Statfs),
            (Fstatfs = 138) => do_fstatfs(fd: FileDesc, statfs_buf: *mut Statfs),
            (SysFs = 139) => handle_unsupported(139),
            (Getpriority = 140) => do_get_priority(which: i32, who: i32),
            (Setpriority = 141) => do_set_priority(which: i32, who: i32, prio: i32),
            (SchedSetparam = 142) => handle_unsupported(142),
            (SchedGetparam = 143) => handle_unsupported(143),
            (SchedSetscheduler = 144) => handle_unsupported(144),
            (SchedGetscheduler = 145) => handle_unsupported(145),
            (SchedGetPriorityMax = 146) => handle_unsupported(146),
            (SchedGetPriorityMin = 147) => handle_unsupported(147),
            (SchedRrGetInterval = 148) => handle_unsupported(148),
            (Mlock = 149) => handle_unsupported(149),
            (Munlock = 150) => handle_unsupported(150),
            (Mlockall = 151) => handle_unsupported(151),
            (Munlockall = 152) => handle_unsupported(152),
            (Vhangup = 153) => handle_unsupported(153),
            (ModifyLdt = 154) => handle_unsupported(154),
            (PivotRoot = 155) => handle_unsupported(155),
            (SysCtl = 156) => handle_unsupported(156),
            (Prctl = 157) => do_prctl(option: i32, arg2: u64, arg3: u64, arg4: u64, arg5: u64),
            (ArchPrctl = 158) => do_arch_prctl(code: u32, addr: *mut usize),
            (Adjtimex = 159) => handle_unsupported(159),
            (Setrlimit = 160) => do_settrlimit(resource: u32, rlim: *const rlimit_t),
            (Chroot = 161) => handle_unsupported(161),
            (Sync = 162) => do_sync(),
            (Acct = 163) => handle_unsupported(163),
            (Settimeofday = 164) => handle_unsupported(164),
            ...
            (Swapon = 167) => handle_unsupported(167),
            (Swapoff = 168) => handle_unsupported(168),
            (Reboot = 169) => handle_unsupported(169),
            (Sethostname = 170) => handle_unsupported(170),
            (Setdomainname = 171) => handle_unsupported(171),
            (Iopl = 172) => handle_unsupported(172),
            (Ioperm = 173) => handle_unsupported(173),
            (CreateModule = 174) => handle_unsupported(174),
            (InitModule = 175) => handle_unsupported(175),
            (DeleteModule = 176) => handle_unsupported(176),
            (GetKernelSyms = 177) => handle_unsupported(177),
            (QueryModule = 178) => handle_unsupported(178),
            (Quotactl = 179) => handle_unsupported(179),
            (Nfsservctl = 180) => handle_unsupported(180),
            (Getpmsg = 181) => handle_unsupported(181),
            (Putpmsg = 182) => handle_unsupported(182),
            (AfsSysCall = 183) => handle_unsupported(183),
            (Tuxcall = 184) => handle_unsupported(184),
            (Security = 185) => handle_unsupported(185),
            (Gettid = 186) => do_gettid(),
            (Readahead = 187) => handle_unsupported(187),
            (Setxattr = 188) => handle_unsupported(188),
            (Lsetxattr = 189) => handle_unsupported(189),
            (Fsetxattr = 190) => handle_unsupported(190),
            (Getxattr = 191) => handle_unsupported(191),
            (Lgetxattr = 192) => handle_unsupported(192),
            (Fgetxattr = 193) => handle_unsupported(193),
            (Listxattr = 194) => handle_unsupported(194),
            (Llistxattr = 195) => handle_unsupported(195),
            (Flistxattr = 196) => handle_unsupported(196),
            (Removexattr = 197) => handle_unsupported(197),
            (Lremovexattr = 198) => handle_unsupported(198),
            (Fremovexattr = 199) => handle_unsupported(199),
            ...
            (SetThreadArea = 205) => handle_unsupported(205),
            (IoSetup = 206) => handle_unsupported(206),
            (IoDestroy = 207) => handle_unsupported(207),
            (IoGetevents = 208) => handle_unsupported(208),
            (IoSubmit = 209) => handle_unsupported(209),
            (IoCancel = 210) => handle_unsupported(210),
            (GetThreadArea = 211) => handle_unsupported(211),
            (LookupDcookie = 212) => handle_unsupported(212),
            (EpollCreate = 213) => do_epoll_create(size: c_int),
            (EpollCtlOld = 214) => handle_unsupported(214),
            (EpollWaitOld = 215) => handle_unsupported(215),
            (RemapFilePages = 216) => handle_unsupported(216),
            (Getdents64 = 217) => do_getdents64(fd: FileDesc, buf: *mut u8, buf_size: usize),
            (SetTidAddress = 218) => do_set_tid_address(tidptr: *mut pid_t),
            (RestartSysCall = 219) => handle_unsupported(219),
            (Semtimedop = 220) => handle_unsupported(220),
            (Fadvise64 = 221) => handle_unsupported(221),
            (TimerCreate = 222) => handle_unsupported(222),
            (TimerSettime = 223) => handle_unsupported(223),
            (TimerGettime = 224) => handle_unsupported(224),
            (TimerGetoverrun = 225) => handle_unsupported(225),
            (TimerDelete = 226) => handle_unsupported(226),
            (ClockSettime = 227) => handle_unsupported(227),
            ...
            (Vserver = 236) => handle_unsupported(236),
            (Mbind = 237) => handle_unsupported(237),
            (SetMempolicy = 238) => handle_unsupported(238),
            (GetMempolicy = 239) => handle_unsupported(239),
            (MqOpen = 240) => handle_unsupported(240),
            (MqUnlink = 241) => handle_unsupported(241),
            (MqTimedsend = 242) => handle_unsupported(242),
            (MqTimedreceive = 243) => handle_unsupported(243),
            (MqNotify = 244) => handle_unsupported(244),
            (MqGetsetattr = 245) => handle_unsupported(245),
            (KexecLoad = 246) => handle_unsupported(246),
            (Waitid = 247) => handle_unsupported(247),
            (AddKey = 248) => handle_unsupported(248),
            (RequestKey = 249) => handle_unsupported(249),
            (Keyctl = 250) => handle_unsupported(250),
            (IoprioSet = 251) => handle_unsupported(251),
            (IoprioGet = 252) => handle_unsupported(252),
            (InotifyInit = 253) => handle_unsupported(253),
            (InotifyAddWatch = 254) => handle_unsupported(254),
            (InotifyRmWatch = 255) => handle_unsupported(255),
            (MigratePages = 256) => handle_unsupported(256),
            (Openat = 257) => do_openat(dirfd: i32, path: *const i8, flags: u32, mode: u16),
            (Mkdirat = 258) => do_mkdirat(dirfd: i32, path: *const i8, mode: u16),
            (Mknodat = 259) => handle_unsupported(259),
            ...
            (Unshare = 272) => handle_unsupported(272),
            ...
            (Splice = 275) => handle_unsupported(275),
            (Tee = 276) => handle_unsupported(276),
            (SyncFileRange = 277) => handle_unsupported(277),
            (Vmsplice = 278) => handle_unsupported(278),
            (MovePages = 279) => handle_unsupported(279),
            ...
            (Signalfd = 282) => handle_unsupported(282),
            ...
            (Signalfd4 = 289) => handle_unsupported(289),
            ...
            (InotifyInit1 = 294) => handle_unsupported(294),
            ...
            (RtTgsigqueueinfo = 297) => handle_unsupported(297),
            (PerfEventOpen = 298) => handle_unsupported(298),
            (Recvmmsg = 299) => handle_unsupported(299),
            (FanotifyInit = 300) => handle_unsupported(300),
            (FanotifyMark = 301) => handle_unsupported(301),
            (Prlimit64 = 302) => do_prlimit(pid: pid_t, resource: u32, new_limit: *const rlimit_t, old_limit: *mut rlimit_t),
            (NameToHandleAt = 303) => handle_unsupported(303),
            (OpenByHandleAt = 304) => handle_unsupported(304),
            (ClockAdjtime = 305) => handle_unsupported(305),
            (Syncfs = 306) => handle_unsupported(306),
            (Sendmmsg = 307) => do_sendmmsg(fd: c_int, msg_ptr: *mut mmsghdr, vlen: c_uint, flags_c: c_int),
            (Setns = 308) => handle_unsupported(308),
            (Getcpu = 309) => do_getcpu(cpu_ptr: *mut u32, node_ptr: *mut u32),
            (ProcessVmReadv = 310) => handle_unsupported(310),
            (ProcessVmWritev = 311) => handle_unsupported(311),
            (Kcmp = 312) => handle_unsupported(312),
            (FinitModule = 313) => handle_unsupported(313),
            (SchedSetattr = 314) => handle_unsupported(314),
            (SchedGetattr = 315) => handle_unsupported(315),
            (Renameat2 = 316) => handle_unsupported(316),
            (Seccomp = 317) => handle_unsupported(317),
            (Getrandom = 318) => do_getrandom(buf: *mut u8, len: size_t, flags: u32),
            (MemfdCreate = 319) => handle_unsupported(319),
            (KexecFileLoad = 320) => handle_unsupported(320),
            (Bpf = 321) => handle_unsupported(321),
            (Execveat = 322) => handle_unsupported(322),
            (Userfaultfd = 323) => handle_unsupported(323),
            (Membarrier = 324) => handle_unsupported(324),
            (Mlock2 = 325) => handle_unsupported(325),
            (CopyFileRange = 326) => handle_unsupported(326),
            (Preadv2 = 327) => handle_unsupported(327),
            (Pwritev2 = 328) => handle_unsupported(328),
            (PkeyMprotect = 329) => handle_unsupported(329),
            (PkeyAlloc = 330) => handle_unsupported(330),
            (PkeyFree = 331) => handle_unsupported(331),
            (Statx = 332) => handle_unsupported(332),
            (IoPgetevents = 333) => handle_unsupported(333),
            (Rseq = 334) => handle_unsupported(334),
